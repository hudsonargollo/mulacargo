...
export function BankDetails() {
  ...
  useEffect(() => {
    if (selfDriver) {
      console.log('self driver data in bank details is ---->', selfDriver)
      const data = {
      ...
      setIsPrimary(selfDriver?.payment_account?.default || null)
    }
  }, [selfDriver])

  const isChanged = JSON.stringify(formData) !== JSON.stringify(initialFormData) || (selfDriver?.payment_account?.default || null) !== isPrimary
