...
class CategoryRepository extends BaseRepository
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            DB::commit();
            if ($request->has('save')) {
                return to_route('admin.category.create', ['category' => $category->id, 'locale' => $locale])->with('success', __('static.categories.create_successfully'));
            }
    ...
    public function update($request, $id)
    {
        ...
        try {
            ...
            if (array_key_exists('save', $request)) {
                return to_route('admin.category.edit', ['category' => $category->id, 'locale' => $locale])
                    ->with('success', __('static.categories.update_successfully'));
            }
