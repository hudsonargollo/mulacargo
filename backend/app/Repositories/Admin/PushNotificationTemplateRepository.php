...
class PushNotificationTemplateRepository extends BaseRepository
{
    ...
    public function index($request)
    {
        ...
        $statuses = $this->model->pluck('status', 'slug')->toArray();

        return view('admin.push-notification-template.index' , ['pushNotificationTemplates' => $pushNotificationTemplates, 'statuses' => $statuses]);
    }
