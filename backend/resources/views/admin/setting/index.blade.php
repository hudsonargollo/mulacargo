        ...
        <div class="inside">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <x-image :name="'general[light_logo_image_id]'"
                                                        :data="isset($settings['general']['light_logo_image'])
            ...
            : old('general.light_logo_image_id')" :text="false"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <x-image :name="'general[dark_logo_image_id]'"
                                                        :data="isset($settings['general']['dark_logo_image'])
            ...
            : old('general.dark_logo_image_id')" :text="false"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    <x-image :name="'general[favicon_image_id]'"
                                                        :data="isset($settings['general']['favicon_image'])
            ...
            : old('general.favicon_image_id')" :text="false"
                                            ...
                                            <div class="col-md-10 error-div select-dropdown">
                                                <select class="select-2 form-control select-country"
                                                    ...
                                                    @forelse ($timeZones as $timeZone)
                                                        <option class="option" value={{ $timeZone->value }} @if ($settings['general']['default_timezone'] ?? old('default_timezone')) @if ($timeZone->value == $settings['general']['default_timezone'])
                                                        selected @endif @endif>{{ $timeZone->label() }}</option>
                                                    @empty
                                        ...
                                        <div class="form-group row">
                                            <label for="time_format"
                                                class="col-md-2">{{ __('static.settings.time_format') }}</label>
                                            <div class="col-md-10 error-div select-dropdown">
                                                <select class="select-2 form-control select-time-format" id="time_format"
                                                    name="general[time_format]"
                                                    data-placeholder="{{ __('static.settings.select_time_format') }}">
                                                    <option class="select-placeholder" value=""></option>
                                                    @forelse ([12 => '12-Hour (AM/PM)', 24 => '24-Hour'] as $key => $option)
                                                        <option class="option" value="{{ $key }}" @if (($settings['general']['time_format'] ?? old('time_format')) == $key)
                                                        selected @endif>
                                                            {{ $option }}
                                                        </option>
                                                    @empty
                                            ...
                                            <div class="col-md-10 error-div select-dropdown">
                                                <select class="select-2 form-control select-country"
                                                    ...
                                                    @forelse ($smsGateways as $smsGateway)
                                                        <option class="option" value="{{ $smsGateway['slug'] }}" @if ($settings['general']['default_sms_gateway'] ?? old('default_sms_gateway')) @if ($smsGateway['slug'] == $settings['general']['default_sms_gateway'])
                                                        selected @endif @endif>{{ $smsGateway['name'] }}</option>
                                                    @empty
                                                        <option value="" disabled></option>
                                                    @endforelse
                                                </select>
                                            ...
                                            <div class="col-md-10 error-div select-dropdown">
                                                <select class="select-2 form-control select-country"
                                                    ...
                                                    @forelse (getLanguage() as $key => $option)
                                                        <option class="option" value={{ $key }} @if ($settings['general']['default_language_id'] ?? old('default_language_id')) @if ($key == $settings['general']['default_language_id']) selected @endif
                                                        @endif>{{ $option }}</option>
                                                    @empty
                                                        <option value="" disabled></option>
                                                    @endforelse
                                            ...
                                            <div class="col-md-10 error-div select-dropdown">
                                                <select class="select-2 form-control select-currency"
                                                    ...
                                                    @forelse (getCurrencies() as $key => $option)
                                                        <option class="option" value={{ $key }} @if ($settings['general']['default_currency_id'] ?? old('default_currency_id')) @if ($key == $settings['general']['default_currency_id']) selected @endif
                                                        @endif>{{ $option }}</option>
                                                    @empty
                                                        <option value="" disabled></option>
                                                    @endforelse
                                        ...
                                        <div class="form-group row">
                                            <label for="mode" class="col-md-2">{{ __('static.settings.mode') }}</label>
                                            <div class="col-md-10 error-div select-dropdown">
                                                <select class="select-2 form-control select-mode" id="mode"
                                                    ...
                                                    @forelse (['dark' => 'Dark', 'light' => 'Light'] as $key => $option)
                                                        <option class="option" value={{ $key }} @if ($settings['general']['mode'] ?? old('mode')) @if ($key == $settings['general']['mode']) selected @endif @endif>
                                                            {{ $option }}</option>
                                                    @empty
                                                        <option value="" disabled></option>
                                                    @endforelse
                                    ...
                                    <div class="tab-pane fade" id="Appearance" role="tabpanel"
                                        ...
                                        <div class="form-group row">
                                            <label class="col-xxl-3 col-md-4" for="appearance[secondary_color]">
                                                ...
                                                <i class="ri-error-warning-line" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" data-bs-custom-class="custom-tooltip"
                                                    data-bs-title="{{ __('Select secondary color for front.') }}">
                                                </i>
                                            </label>
                                            <div class="col-xxl-9 col-md-8">
                                                <input type="color" class="form-control color-picker"
                                                    name="appearance[secondary_color]"
                                                    value="{{ $settings['appearance']['secondary_color'] ?? '#115444' }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select id="sidebar-bg-type" class="form-control"
                                                    ...
                                                    <option value="solid" {{ ($settings['appearance']['sidebar_background_type'] ?? '') == 'solid' ? 'selected' : '' }}>
                                                        Solid
                                                    </option>
                                                    <option value="gradient" {{ ($settings['appearance']['sidebar_background_type'] ?? '') == 'gradient' ? 'selected' : '' }}>
                                                        Gradient
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" name="appearance[font_family]">
                                                    <option value="Inter" {{ $settings['appearance']['font_family'] == 'Inter' ? 'selected' : '' }}>
                                                        Inter
                                                    </option>
                                                    <option value="Inter" {{ $settings['appearance']['font_family'] == 'Inter' ? 'selected' : '' }}>
                                                        Inter
                                                    </option>
                                                    <option value="Arial" {{ $settings['appearance']['font_family'] == 'Arial' ? 'selected' : '' }}>
                                                        Arial
                                                    </option>
                                                    <option value="Times New Roman" {{ $settings['appearance']['font_family'] == 'Times New Roman' ? 'selected' : '' }}>
                                                        Times New Roman</option>
                                                    <option value="Roboto" {{ $settings['appearance']['font_family'] == 'Roboto' ? 'selected' : '' }}>
                                                        Roboto
                                                    </option>
                                                    <option value="Poppins" {{ $settings['appearance']['font_family'] == 'Poppins' ? 'selected' : '' }}>
                                                        Poppins</option>
                                                    <option value="Lato" {{ $settings['appearance']['font_family'] == 'Lato' ? 'selected' : '' }}>
                                                        Lato
                                                    </option>
                                                    <option value="Open Sans" {{ $settings['appearance']['font_family'] == 'Open Sans' ? 'selected' : '' }}>
                                                        Open Sans</option>
                                                    <option value="Montserrat" {{ $settings['appearance']['font_family'] == 'Montserrat' ? 'selected' : '' }}>
                                                        Montserrat</option>
                                                    <option value="Nunito" {{ $settings['appearance']['font_family'] == 'Nunito' ? 'selected' : '' }}>
                                                        Nunito
                                                    </option>
                                                    <option value="Oswald" {{ $settings['appearance']['font_family'] == 'Oswald' ? 'selected' : '' }}>
                                                        Oswald
                                                    </option>
                                                    <option value="Merriweather" {{ $settings['appearance']['font_family'] == 'Merriweather' ? 'selected' : '' }}>
                                                        Merriweather</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-9">
                                                <select class="form-control" name="appearance[front_font_family]">
                                                    <option value="DM Sans" {{ $settings['appearance']['front_font_family'] == 'DM Sans' ? 'selected' : '' }}>DM Sans</option>
                                                    <option value="Arial" {{ $settings['appearance']['front_font_family'] == 'Arial' ? 'selected' : '' }}>Arial</option>
                                                    <option value="Times New Roman" {{ $settings['appearance']['front_font_family'] == 'Times New Roman' ? 'selected' : '' }}>Times New Roman</option>
                                                    <option value="Roboto" {{ $settings['appearance']['front_font_family'] == 'Roboto' ? 'selected' : '' }}>Roboto</option>
                                                    <option value="Poppins" {{ $settings['appearance']['front_font_family'] == 'Poppins' ? 'selected' : '' }}>Poppins</option>
                                                    <option value="Lato" {{ $settings['appearance']['front_font_family'] == 'Lato' ? 'selected' : '' }}>Lato</option>
                                                    <option value="Open Sans" {{ $settings['appearance']['front_font_family'] == 'Open Sans' ? 'selected' : '' }}>Open Sans</option>
                                                    <option value="Montserrat" {{ $settings['appearance']['front_font_family'] == 'Montserrat' ? 'selected' : '' }}>Montserrat</option>
                                                    <option value="Nunito" {{ $settings['appearance']['front_font_family'] == 'Nunito' ? 'selected' : '' }}>Nunito</option>
                                                    <option value="Oswald" {{ $settings['appearance']['front_font_family'] == 'Oswald' ? 'selected' : '' }}>Oswald</option>
                                                    <option value="Merriweather" {{ $settings['appearance']['front_font_family'] == 'Merriweather' ? 'selected' : '' }}>Merriweather</option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-xxl-9 col-md-8">
                                                <div class="form-group">
                                                    <x-image :name="'appearance[preloader_image_id]'"
                                                        :data="isset($settings['appearance']['preloader_image']) ? $settings['appearance']['preloader_image'] : null" :text="false"
                                                        :multiple="false"></x-image>
                                                ...
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($settings['activation']['social_login_enable']))
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                name="activation[social_login_enable]" value="1" {{ $settings['activation']['social_login_enable'] ? 'checked' : '' }}>
                                                        @else
                                                            <input class="form-control" type="hidden"
                                                                name="activation[social_login_enable]" value="0">
                                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($settings['activation']['default_credentials']))
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                name="activation[default_credentials]" value="1" {{ $settings['activation']['default_credentials'] ? 'checked' : '' }}>
                                                        @else
                                                            <input class="form-control" type="hidden"
                                                                name="activation[default_credentials]" value="0">
                                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($settings['activation']['demo_mode']))
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="activation[demo_mode]" value="1" {{ $settings['activation']['demo_mode'] ? 'checked' : '' }}>
                                                        @else
                                                            <input class="form-control" type="hidden" name="activation[demo_mode]" value="0">
                                                ...
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($settings['activation']['preloader_enabled']))
                                                            ...
                                                            <input class="form-check-input" type="checkbox" name="activation[preloader_enabled]" value="1" {{ $settings['activation']['preloader_enabled'] ? 'checked' : '' }}>
                                                        @else
                                                ...
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($settings['google_reCaptcha']['status']))
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                name="google_reCaptcha[status]" value="1" {{ $settings['google_reCaptcha']['status'] ? 'checked' : '' }}>
                                                        @else
                                                            <input class="form-control" type="hidden"
                                                                name="google_reCaptcha[status]" value="0">
                                                            <input class="form-check-input" type="checkbox"
                                                    ...
                                                    <div class="file-main-box">
                                                        @if ($firebaseData)
                                                            <input type="hidden" class="form-control mb-2"
                                                                value="{{ $firebaseData['project_id'] ?? 'N/A' }}" readonly>
                                                        @endif
                                                            ...
                                                            <ul class="list-group">
                                                                @foreach ($files as $file)
                                                                    <li
                                                                        ...
                                                                        <span>{{ $file }}</span>
                                                                        <a href="{{ route('admin.download-firebase') }}" download
                                                                            class="btn">
                                                ...
                                                <div class="editor-space">
                                                    <label class="switch">
                                                        @if (isset($settings['maintenance']['maintenance_mode']))
                                                            ...
                                                            <input class="form-check-input" type="checkbox"
                                                                name="maintenance[maintenance_mode]" value="1" {{ $settings['maintenance']['maintenance_mode'] ? 'checked' : '' }}>
                                                        @else
                                                            <input class="form-control" type="hidden"
                                                                name="maintenance[maintenance_mode]" value="0">
                                                            <input class="form-check-input" type="checkbox"
                                        ...
                                        <div class="form-group row ">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control image-embed-content"
                                                    placeholder="{{ __('static.notify_templates.enter_content') }}" rows="4"
                                    ...
                                    <button type="submit" class="btn  spinner-btn btn-primary" id="savebtn"><i
                                            class="ri-save-line text-white lh-1 "></i>{{ __('static.save') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
