...
return [
    ...
    'auth' => [
        'sended_otp_registered_numb' => 'لقد أرسلنا Código de Confirmación إلى رقم الهاتف المسجل.',
        'sms_login_not_enable' => 'طريقة تسجيل الدخول عبر الرسائل النصية غير مفعلة حاليًا',
        'invalid_auth_token' => 'Código de Confirmación المقدم غير صالح.',
    ...
    'riders' => [
        ...
        'country' => 'البلد',
        'parcel_otp_disabled' => 'Código de Confirmación الطرود معطل لإكمال الرحلة.',
        'vehicle_information' => 'معلومات المركبة',
        'seats' => 'المقاعد',
        'payment_method' => 'طريقة الدفع',
        'payment_status' => 'حالة الدفع',
    ...
    'rides' => [
        ...
        'payment_status' => 'حالة الدفع',
        'otp' => 'Código de Confirmación بدء الرحلة ',
        'parcel_otp' => 'Código de Confirmación تسليم الطرد ',
        ...
        'parcel_otps' => 'Código de Confirmación الطرود',
        ...
        'invalid_otp' => 'Código de Confirmación غير صالح لبدء الرحلة.',
    ...
    'settings' => [
        ...
        'ride_otp' => 'التحقق من Código de Confirmación الرحلة',
        'parcel_otp' => 'التحقق من Código de Confirmación الطرد',
        'otp_parcel' => 'إذا تم تفعيله، يدخل المستلم Código de Confirmación للحصول على الطرد. إذا تم تعطيله، يحدث التسليم مباشرة.',
        ...
        'otp_ride' => 'إذا تم تفعيله، تبدأ الرحلة فقط بعد إدخال Código de Confirmación. إذا تم تعطيله، تبدأ الرحلة مباشرة.',
    ...
    'sos' => [
        'email' => [
            'subject' => '🚨 تم تفعيل حالة الطوارئ SOS',
            'greeting' => 'مطلوب الانتباه!',
            'body' => 'تم تفعيل تنبيه SOS أثناء الرحلة.',
            'ride_id' => 'رقم الرحلة: #{{ride_number}}',
            'coordinates' => 'الإحداثيات: خط العرض {{lat}}، خط الطول {{lng}}',
            'action' => 'عرض تفاصيل SOS',
            'footer' => 'يرجى الاستجابة فورًا.',
        ],
        'notification' => [
            'title' => 'تم تفعيل حالة الطوارئ SOS',
            'message' => '🚨 تم تفعيل تنبيه SOS أثناء الرحلة #{{ride_number}}. مطلوب الانتباه فورًا.',
            'driver_message' => '🚨 قام السائق :driver_name بتفعيل حالة الطوارئ SOS. نوع السيارة: :vehicle_type.',
            'driver_message_no_ride' => '🚨 قام السائق :driver_name بتفعيل حالة الطوارئ SOS. نوع السيارة: :vehicle_type',
            'rider_message' => '🚨 قام الراكب :rider_name (:rider_email) بتفعيل حالة الطوارئ SOS. الرحلة: #:ride_number',
            'rider_message_no_ride' => '🚨 قام الراكب :rider_name (:rider_email) بتفعيل حالة الطوارئ SOS',
        ],
    ],
];
