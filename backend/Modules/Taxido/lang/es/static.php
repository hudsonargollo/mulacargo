...
return [
    ...
    'drivers' => [
        ...
        'price_per_type' => 'Precio por Tipo',
        'select_price_types' => 'Seleccionar Precio por Tipo',
        'gear_type' => 'Tipo de Transmisión',
        'select_gear_type' => 'Seleccionar Tipo de Transmisión',
        'automatic' => 'Automático',
        'manual' => 'Manual',
    ],
    'auth' => [
        'sended_otp_registered_numb' => 'Hemos enviado un Código de Confirmación al número de teléfono registrado.',
        'sms_login_not_enable' => 'El método de inicio de sesión por SMS no está habilitado actualmente.',
        'invalid_auth_token' => 'El Código de Confirmación proporcionado es inválido.',
    ...
    'riders' => [
        ...
        'country' => 'País',
        'parcel_otp_disabled' => 'Código de Confirmación de paquete desactivado para completar el viaje.',
        'vehicle_information' => 'Información del Vehículo',
        'seats' => 'Asientos',
        'payment_method' => 'Método de Pago',
        'payment_status' => 'Estado del Pago',
    ...
    'rides' => [
        ...
        'payment_status' => 'Estado del Pago',
        'otp' => 'Código de Confirmación para Iniciar Viaje',
        'parcel_otp' => 'Código de Confirmación para Entrega de Paquete',
        ...
        'parcel_otps' => 'Código de Confirmación de Paquete',
        ...
        'invalid_otp' => 'Código de Confirmación inválido para iniciar el viaje.',
...
'action' => 'Acción',
    ...
    'settings' => [
        ...
        'ride_otp' => 'Verificación Código de Confirmación de Viaje',
        'parcel_otp' => 'Verificación Código de Confirmación de Paquete',
        'otp_parcel' => 'Si está habilitado, el receptor ingresa un Código de Confirmación para recibir el paquete. Si está desactivado, la entrega se realiza directamente.',
        ...
        'otp_ride' => 'Si está habilitado, el viaje comienza solo después de ingresar el Código de Confirmación. Si está desactivado, el viaje comienza directamente.',
        'interval' => 'Intervalo',
        'days' => 'Día',
        'months' => 'Mes',
   ...
   'statuses' => [
    ...
    'sos' => [
        'email' => [
            'subject' => '🚨 Alerta SOS Activada',
            'greeting' => '¡Atención requerida!',
            'body' => 'Se activó una alerta SOS durante un viaje.',
            'ride_id' => 'ID del viaje: #{{ride_number}}',
            'coordinates' => 'Coordenadas: Latitud {{lat}}, Longitud {{lng}}',
            'action' => 'Ver detalles de SOS',
            'footer' => 'Por favor responda de inmediato.',
        ],
        'notification' => [
            'title' => 'Alerta SOS Activada',
            'message' => '🚨 Alerta SOS activada durante el viaje #{{ride_number}}. Se requiere atención inmediata.',
            'driver_message' => '🚨 El conductor :driver_name activó SOS. Tipo de vehículo: :vehicle_type. Viaje: #:ride_number',
            'driver_message_no_ride' => '🚨 El conductor :driver_name activó SOS. Tipo de vehículo: :vehicle_type',
            'rider_message' => '🚨 El pasajero :rider_name (:rider_email) activó SOS. Viaje: #:ride_number',
            'rider_message_no_ride' => '🚨 El pasajero :rider_name (:rider_email) activó SOS',
        ],
    ],
];
