...
return [
    ...
    'otp_send_successfully' => '¡El Código de Confirmación se envió exitosamente!',
    ...
    'expired_date_required' => "Se requiere una fecha de vencimiento para el documento ':name'.",
];