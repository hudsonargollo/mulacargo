...
return [
    ...
    'drivers' => [
        ...
        'price_per_type' => 'Preis pro Typ',
        'select_price_types' => 'Preis pro Typ auswählen',
        'gear_type' => 'Getriebetyp',
        'select_gear_type' => 'Getriebetyp auswählen',
        'automatic' => 'Automatik',
    ...
    'auth' => [
        'sended_otp_registered_numb' => 'Wir haben einen Código de Confirmación an die registrierte Telefonnummer gesendet.',
        'sms_login_not_enable' => 'Die SMS-Anmeldemethode ist derzeit nicht aktiviert.',
        'invalid_auth_token' => 'Der angegebene Código de Confirmación ist ungültig.',
    ...
    'riders' => [
        ...
        'country' => 'Land',
        'parcel_otp_disabled' => 'Paket-Código de Confirmación für Fahrtabschluss deaktiviert.',
        'vehicle_information' => 'Fahrzeuginformationen',
        'seats' => 'Sitze',
        'payment_method' => 'Zahlungsmethode',
        'payment_status' => 'Zahlungsstatus',
    ...
    'rides' => [
        ...
        'payment_status' => 'Zahlungsstatus',
        'otp' => 'Fahrtstart-Código de Confirmación',
        'parcel_otp' => 'Paket zugestellt Código de Confirmación',
        ...
        'parcel_otps' => 'Paket-Código de Confirmación',
        ...
        'invalid_otp' => 'Ungültiger Código de Confirmación für den Fahrtstart.',
    ...
    'settings' => [
        ...
        'ride_otp' => 'Fahrt-Código de Confirmación-Verifizierung',
        'parcel_otp' => 'Paket-Código de Confirmación-Verifizierung',
        'otp_parcel' => 'Wenn aktiviert, gibt der Empfänger einen Código de Confirmación ein, um das Paket zu erhalten. Wenn deaktiviert, erfolgt die Lieferung direkt.',
        ...
        'otp_ride' => 'Wenn aktiviert, startet die Fahrt erst nach Eingabe des Código de Confirmación. Wenn deaktiviert, startet die Fahrt direkt.',
        'interval' => 'Intervall',
        'days' => 'Tag',
        'months' => 'Monat',
    ...
    'sos' => [
        'email' => [
            'subject' => '🚨 SOS-Alarm ausgelöst',
            'greeting' => 'Achtung erforderlich!',
            'body' => 'Ein SOS-Alarm wurde während einer Fahrt ausgelöst.',
            'ride_id' => 'Fahrt-ID: #{{ride_number}}',
            'coordinates' => 'Koordinaten: Breitengrad {{lat}}, Längengrad {{lng}}',
            'action' => 'SOS-Details anzeigen',
            'footer' => 'Bitte sofort antworten.',
        ],
        'notification' => [
            'title' => 'SOS-Alarm ausgelöst',
            'message' => '🚨 SOS-Alarm während der Fahrt #{{ride_number}} ausgelöst. Sofortige Aufmerksamkeit erforderlich.',
            'driver_message' => '🚨 Fahrer :driver_name hat SOS ausgelöst. Fahrzeugtyp: :vehicle_type.',
            'driver_message_no_ride' => '🚨 Fahrer :driver_name hat SOS ausgelöst. Fahrzeugtyp: :vehicle_type',
            'rider_message' => '🚨 Fahrgast :rider_name (:rider_email) hat SOS ausgelöst. Fahrt: #:ride_number',
            'rider_message_no_ride' => '🚨 Fahrgast :rider_name (:rider_email) hat SOS ausgelöst',
        ],
    ],
];
