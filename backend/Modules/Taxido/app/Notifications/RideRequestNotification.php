...
class RideRequestNotification extends Notification implements ShouldQueue
{
    ...
    */
    ...
    {
        Log::info('inside  ride request  notification');
        $this->driver = $driver;
    ...
    {
        $template = EmailTemplate::where('slug', 'ride-request-driver')->first();
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                ...
                ->markdown('taxido::emails.email-template', [
                    'content' => $content, 'emailContent' => $emailContent ,'locale' => $locale
                ]);
    }
