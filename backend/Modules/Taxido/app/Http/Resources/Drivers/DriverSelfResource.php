...
class DriverSelfResource  extends BaseResource
{
    ...
    public function toArray(Request $request): array
    {
        $driverSelf = [
            ...
            'per_day_charge' => $this->per_day_charge,
            ...
            'vehicle_info' => [
                ...
                'name' => $this->ambulance?->name ?? $this->vehicle_info?->vehicle?->name,
                'description' => $this->ambulance?->description ?? $this->vehicle_info?->vehicle?->description,
        ...
        if($this->preferences) {
            $driverSelf['preferences'] = PreferenceResource::collection($this->preferences);
        }
