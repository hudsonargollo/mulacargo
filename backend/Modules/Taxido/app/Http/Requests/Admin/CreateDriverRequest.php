...
class CreateDriverRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'status' => ['required'],
            'referral_code' => ['nullable', 'string', 'max:255', Rule::unique('users', 'referral_code')->whereNull('deleted_at')],
            ...
            'gear_type' => [ 'nullable','required_if:gear_type,finddriver', 'in:automatic,manual'],
        ];
    ...
    {
        Log::info('CreateDriverRequest validation failed: ', $validator->errors()->toArray());
