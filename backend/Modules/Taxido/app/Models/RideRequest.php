...
class RideRequest extends Model
{
    ...
    protected $casts = [
        ...
        'driver_acceptance_expires_at' => 'datetime',
        'find_driver_expires_at' => 'datetime',
    ...
    public static function boot()
    {
        ...
        static::saved(function ($model) {
            broadcast(new RideRequestBroadcast($model));
        });
    }
    ...
    {
        return $this->hasMany(RideStatusActivity::class, 'ride_request_id');
    }
    ...
    {
        return $this->belongsToMany(Preference::class, 'ride_request_preferences');
    }
    ...
    {
        return $this->hasOne(Ride::class, 'ride_number', 'ride_number');
    }

    /**
     * Get the latest status of the ride request.
     */
    public function getStatusAttribute()
    {
        return $this->ride_status_activities()->latest('changed_at')->value('status');
    }
}
