...
use Modules\Taxido\Exports\DriverReportExport;
...
class DriverReportRepository extends BaseRepository
{
    ...
    {
        return Excel::download(new DriverReportExport, 'driversReport.xlsx');
    }

    public function exportCsv()
    {
        return Excel::download(new DriverReportExport, 'driversReport.csv');
    }
}
